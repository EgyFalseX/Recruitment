...
{
    [DomainComponent]
    [DevExpress.ExpressApp.DC.XafDisplayName("Balance Sheet Parameters")]
    ...
    public class RepParam_acc_Rep_Balance_Sheet : ReportParametersObjectBase
    {
        public RepParam_acc_Rep_Balance_Sheet(IObjectSpaceCreator provider) : base(provider)
        {
        }
        ...
        [RuleRequiredField("RepParam_acc_Rep_Balance_Sheet_FiscalYear_vld_req", DefaultContexts.Save, "Fiscal Year should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Balance_Sheet_Startdate_vld_req", DefaultContexts.Save, "From Date should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Balance_Sheet_Enddate_vld_req", DefaultContexts.Save, "To Date should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Balance_Sheet_Cateogry_vld_req", DefaultContexts.Save, "Cateogry should not be empty!")]
