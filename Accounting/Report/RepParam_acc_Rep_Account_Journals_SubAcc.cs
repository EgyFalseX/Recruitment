...
{
    [DomainComponent]
    [DevExpress.ExpressApp.DC.XafDisplayName("Account Journals (Sub Account) Parameters")]
    ...
    public class RepParam_acc_Rep_Account_Journals_SubAcc : ReportParametersObjectBase
    {
        public RepParam_acc_Rep_Account_Journals_SubAcc(IObjectSpaceCreator provider) : base(provider)
        {
        }
        ...
        [RuleRequiredField("RepParam_acc_Rep_Account_Journals_SubAc_FiscalYear_vld_req", DefaultContexts.Save, "Fiscal Year should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Account_Journals_SubAc_Startdate_vld_req", DefaultContexts.Save, "From Date should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Account_Journals_SubAc_Enddate_vld_req", DefaultContexts.Save, "To Date should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Account_Journals_SubAc_Account_vld_req", DefaultContexts.Save, "Account should not be empty!")]
