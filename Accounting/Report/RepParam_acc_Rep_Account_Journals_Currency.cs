...
{
    [DomainComponent]
    [DevExpress.ExpressApp.DC.XafDisplayName("Account Journals Per Currency Parameters")]
    ...
    public class RepParam_acc_Rep_Account_Journals_Currency : ReportParametersObjectBase
    {
        public RepParam_acc_Rep_Account_Journals_Currency(IObjectSpaceCreator provider) : base(provider)
        {
        }
        ...
        [RuleRequiredField("RepParam_acc_Rep_Account_Journals_Currency_FiscalYear_vld_req", DefaultContexts.Save, "Fiscal Year should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Account_Journals_Currency_Startdate_vld_req", DefaultContexts.Save, "From Date should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Account_Journals_Currency_Enddate_vld_req", DefaultContexts.Save, "To Date should not be empty!")]
        ...
        [RuleRequiredField("RepParam_acc_Rep_Account_Journals_Currency_Account_vld_req", DefaultContexts.Save, "Account should not be empty!")]
