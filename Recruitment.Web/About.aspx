<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Recruitment.Web.About" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Body" runat="server">
    ...
    <section id="contact" class="content-section text-center">
        ...
        <br/>
        <div style="color: #fff; background-color: #b22222; min-height: 300px; padding: 24px;">
            <!-- Sample #7
            ============================================= -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="lead text-xs-center">
                                    <strong>شركة <b class="red">أركان</b> للتوظيف</strong>
                                    <br />

                                    <b class="red">ARKAN</b> Company For Recruitment
                                    <br />
                                    Licence NO.996
                                </p>
                            </div>
