...
namespace Recruitment.Module.Report
{
    ...
    {
        public RepParam_rec_Rep_Activity_01(IObjectSpaceCreator provider) : base(provider)
        {
        }
        ...
        //[RuleRequiredField("RepParam_rec_Rep_Activity_01_Employer_vld_req", DefaultContexts.Save, "Employer should not be empty!")]
        ...
        [RuleRequiredField("RepParam_rec_Rep_Activity_01_Startdate_vld_req", DefaultContexts.Save, "From Date should not be empty!")]
        ...
        [RuleRequiredField("RepParam_rec_Rep_Activity_01_Enddate_vld_req", DefaultContexts.Save, "To Date should not be empty!")]
