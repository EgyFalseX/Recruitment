...
namespace Recruitment.Module.Report
{
    ...
    public class RepParam_rec_Rep_Activity_03 : ReportParametersObjectBase
    {
        public RepParam_rec_Rep_Activity_03(IObjectSpaceCreator provider) : base(provider)
        {
            UnBalance = true;
        }
        ...
        //[RuleRequiredField("RepParam_rec_Rep_Activity_03_Employer_vld_req", DefaultContexts.Save, "Employer should not be empty!")]
        ...
        [RuleRequiredField("RepParam_rec_Rep_Activity_03_Startdate_vld_req", DefaultContexts.Save, "From Date should not be empty!")]
        ...
        [RuleRequiredField("RepParam_rec_Rep_Activity_03_Enddate_vld_req", DefaultContexts.Save, "To Date should not be empty!")]
        ...
        [System.ComponentModel.DisplayName("Select UnBalanced (Only)")]
        public bool UnBalance
        {
            get { return _unBalance; }
            set { _unBalance = value; }
        }
